...
! date: 	27 Feb 2021
! summary: 	This module creates a Delaunay triangulation

MODULE tableDelaunay
IMPLICIT NONE
PRIVATE
...
!> authors: Vikas Sharma, Ph. D.
! date: 	27 Feb 2021
! summary: 	This subroutine returns the triangulation connectivity
!

SUBROUTINE WriteElements( nodecoord, tria3 )
  ! Define intent of dummy variables
  real( kind = 8 ), intent( in ) :: nodecoord( :, : )
    !! Nodal coordinates of points in xiJ format
  integer ( kind = 4 ), allocatable, INTENT( INOUT ) :: tria3( :, : )
    !! Triangulation, its each column represents an element.
